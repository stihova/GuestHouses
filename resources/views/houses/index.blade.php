...
<table class="table table-striped table-bordered">
    ...
    @foreach($houses as $key => $value)
        <tr>
            ...
            <td>
                <a style="background-color: mediumpurple" class="btn btn-primary btn-red" href="{{ route('houses.show', $value->id) }}" method="POST">Show</a>
            </td>

            @if (Auth::check())
            <td>
                <a style="background-color: mediumpurple" class="btn btn-small btn-info" href="{{ URL::to('houses/' . $value->id . '/edit') }}">Edit</a>
            </td>
            <td>
